...
public:
  Selection(QString title){
    ...
    QPushButton* ass_button = new QPushButton("Assisted Reach");
    QPushButton* catch_button = new QPushButton("Chase ");
    QPushButton* taunt_button = new QPushButton("Intercept");
...
class Rupee : public QMainWindow{
  Q_OBJECT

public:
   explicit Rupee(int argc, char** argv, QWidget *parent = 0);
    ~Rupee();
    int init_argc;
    char** init_argv;
